        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { title: "Salami", href: "/products/salami" },
...
export const sampleReviews: Review[] = [
  {
    ...
    name: "Jodie T",
    rating: 5,
    text: "The meat itself is seriously top quality, so tender and full of flavor. I've already recommended it to all my friends and family. If you're looking for a butcher who truly cares about their craft, look no further! 👏👏👏 5 stars from this happy customer 😊",
    date: "2024-01-15",
  },
  {
    id: "2",
    name: "Samantha M",
    rating: 5,
    text: "This is seriously the BEST butchery with the BEST quality. So happy with the service. I will definitely recommend Hokaai Faerie Glen to everyone I know. Thank you for making it such a seamless, friendly experience.",
    date: "2024-01-12",
  },
  {
    id: "3",
    name: "Conrad B",
    rating: 5,
    text: "Fantastic store! Meat is fantastic, the cuts are great. And the prices are good. Biltong and drywors selection are tasty!",
    date: "2024-01-10",
  },
  {
    id: "4",
    name: "Vinette S",
    rating: 5,
    text: "Such good quality meat is hard to come by, and if what you are looking for are not on the shelves, you can ask for at the back and they will immediately get it for you. Fast and friendly. Big store & clean surroundings, nice shopping experience. Even during Covid the service stayed at a high quality. Awesome treats on a Saturday, try the boerewors rolls!!!",
    date: "2024-01-08",
  },
  {
    id: "5",
    name: "Wilhelm K",
    rating: 5,
    text: "The staff are always friendly and the meat quality has been consistently amazing for the past year we have been customers. I would highly recommend their aged rump, it is a great value for money braai meat.",
    date: "2024-01-05",
  },
]
