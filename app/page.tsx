      ...
      <main>
          ...
          <div className="container mx-auto px-6 lg:px-8">
            <div className="lg:max-w-[65%] lg:mx-auto">
              <div className="text-center mb-8 lg:mb-12">
                <h2 className="text-2xl lg:text-4xl text-brand-primary mb-2 lg:mb-4">Shop by Occasion</h2>
        ...
        <section className="py-8 lg:py-16 section-alt">
          <div className="container mx-auto px-6 lg:px-8">
            <div className="lg:max-w-[65%] lg:mx-auto">
              <div className="text-center mb-8 lg:mb-12">
                <h2 className="text-2xl lg:text-4xl text-brand-primary mb-2 lg:mb-4">Deli & Biltong</h2>
                <p className="text-body text-slate-700 max-w-2xl mx-auto hidden lg:block">
        ...
        <section className="py-8 lg:py-16 section-alt">
          <div className="container mx-auto px-6 lg:px-8">
            <div className="text-center mb-8 lg:mb-12">
              <h2 className="text-2xl lg:text-4xl text-brand-primary mb-2 lg:mb-4">What Our Customers Say</h2>
              <p className="text-body text-slate-700 max-w-2xl mx-auto hidden lg:block">
