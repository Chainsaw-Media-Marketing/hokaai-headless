...
export default function ChickenStarPackTrayRoastPage() {
  const recipeData = {
      ...
      <main>
        ...
        <section className="container mx-auto px-6 lg:px-8 pt-8">
          <div className="mb-6 rounded-2xl overflow-hidden">
            <img
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/lemon-Herb%20Chicken%20Star%20Pack%20Tray%20Roast-zl8C07N1YYMdVshUnh5dDenUSrBmxd.png"
              alt="Lemon-Herb Chicken Star Pack Tray Roast"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-8">
                <div className="mb-8">
                  ...
                  <ul className="list-disc pl-6 mt-4 space-y-2 text-foreground/90">
                    <li>1 × 1 kg Hokaai Chicken Star Pack</li>
                    <li>2 tsp Ina Paarman Chicken Spice</li>
                    <li>3 tbsp Ina Paarman Lemon Marinade</li>
              ...
              <div className="lg:col-span-4">
                <div className="self-start rounded-2xl border border-border/40 bg-white/5 shadow-md p-5">
                  <ShopIngredients items={STOCKED_ITEMS} recipeSlug="chicken-star-pack-tray-roast" />
                </div>
              </div>
            </div>
          </div>
